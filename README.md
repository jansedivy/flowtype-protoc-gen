...
load("@flow_protoc_gen//:defs.bzl", "typescript_proto_dependencies")
...
load("@build_bazel_rules_typescript//:defs.bzl", "flow_setup_workspace")
...
```python
load("@flow_protoc_gen//:defs.bzl", "typescript_proto_library")
